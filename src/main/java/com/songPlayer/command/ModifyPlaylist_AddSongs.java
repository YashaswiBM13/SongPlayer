...
public class ModifyPlaylist_AddSongs implements ICommand{
    
    private final IPlaylistService iPlaylistService;

    public ModifyPlaylist_AddSongs(IPlaylistService iPlaylistService){
    ...
    public void execute(List<String> tokens){
        ...
        try{
            PlaylistResponse playlistResponse = iPlaylistService.modifyPlaylist_AddSongs(playlistId, songIdList);
